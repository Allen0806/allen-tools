...
public class AESUtil {
    ...
    private static void encryptLoginParam() {
        ...
        String requestSign = DigestUtil.md5Hex(appId + requestTime + md5Key);
        ...
        loginParam.setUserId("446706638821265408");
        loginParam.setAccessToken("6e2fc16a940c49a4a515a8e01661df1e");
        ...
        loginParam.setOpStation("MI;IIP=36.110.108.162;IPORT=7004;LIP=192168070114;MAC=NA;IDFA=F351D598-525C-49A3-A50B-C1C0B05FD92D;UMPN=NA;RMPN=15210341053;ICCID=NA;OSV=iOS16.2;IMSI=NA;储宝宝+测试=4.5.6.0");
        ...
        param.put("id", 8);
        param.put("appName", "测试应用4");
        param.put("aesKey", "asdfghjkl");
        param.put("aesIv", "asdfghjkl");
        param.put("md5Key", "asdfghjkl");
        param.put("description", "测试应用4");
        param.put("updatedBy", "lxt");
        String paramStr = JsonUtil.object2Json(param);
        System.out.println("param: " + encrypt(paramStr, aesKey, aesIv));
...
//        SecureUtil.md5("123456lczq");
//        System.out.println("password: " + SecureUtil.md5(SecureUtil.md5("Sn123@lczq.com") + "lczq"));
        //Sn123@lczq.com
//        encryptAppInfo();
        encryptLoginParam();
